...
from backend_app.modules.doctor_appointment.services.status_type_service import StatusTypeService
from backend_app.modules.doctor_appointment.schemas.status_type import StatusTypeCreate, StatusTypeUpdate, StatusTypeOut
