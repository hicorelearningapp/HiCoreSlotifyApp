...
from core.channels.instagram.models.instagram_connection import InstagramOAuthState, InstagramConnection
from core.services.instagram_oauth_client import (
    instagram_oauth_client,
    InstagramAPIError,
)
from core.services.instagram_connection_service import instagram_connection_service
from core.services.instagram_token_cipher import instagram_token_cipher, TokenCipherError
...
class InstagramOnboardingService:
    def __init__(self, client=instagram_oauth_client):
        self.client = client
    ...
    def complete_authorization(self, db, state: str, code: str):
        ...
        existing = instagram_connection_service.get_by_account_id(db, account_id)
    ...
    def subscribe_connection(self, db, instagram_account_id: str) -> bool:
        ...
        """
        connection = instagram_connection_service.get_by_account_id(db, instagram_account_id)
    ...
    def disconnect(self, db, instagram_account_id: str) -> dict:
        ...
        instagram_connection_service.disconnect(db, instagram_account_id)
        return {
