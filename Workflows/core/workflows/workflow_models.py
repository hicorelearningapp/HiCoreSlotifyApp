...
class Reply:
    ...
    def __init__(self, message_type: str, text: str, options: list = None, sections: list = None, image_url: str = None, button_text: str = "Select Option", carousel_cards: list = None):
