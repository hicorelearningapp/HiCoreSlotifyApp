...
class DoctorPatientDetailsWorkflow(Workflow):
    def Initialize(self, session: ConversationSession):
        ...
        if not appointment or not appointment.patient:
            return WorkflowResult.end_sequence(reply=Reply("text", "Could not load patient details. Type 'hi' to return to menu."))
        ...
        return WorkflowResult.end_sequence(reply=Reply("text", f"{details}\n\nType 'hi' to return to the main menu."))
